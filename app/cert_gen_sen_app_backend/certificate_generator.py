    ...
    for data in participant_list:
        ...
        if data[3] == "1" or data[3] == "2" or data[3] == "3":
            if data[2] == "1":
                ...
                sendMail("Certificate of Merit", "CONGRATULATIONS... You have secured 1st rank in the event and thank you for participanting in the event.", data[2], f'../app/cert_gen_sen_app_backend/certificate_data/merit-certificates/{str(count)+" "+data[0]}.jpg')
            elif data[3] == "2":
                template = cv2.imread(template_base_dir + "certificate_2nd.jpg")
                meritCertificateGenerate(data[0],data[3]+"nd",event_list[0],event_list[1],event_list[2],template,signature,count)
                sendMail("Certificate of Merit", "CONGRATULATIONS... You have secured 2nd rank in the event and thank you for participanting in the event.", data[2], f'../app/cert_gen_sen_app_backend/certificate_data/merit-certificates/{str(count)+" "+data[0]}.jpg')
            elif data[3] == "3":
                template = cv2.imread(template_base_dir + "certificate_3rd.jpg")
                meritCertificateGenerate(data[0],data[3]+"rd",event_list[0],event_list[1],event_list[2],template,signature,count)
                sendMail("Certificate of Merit", "CONGRATULATIONS... You have secured 3rd rank in the event and thank you for participanting in the event.", data[2], f'../app/cert_gen_sen_app_backend/certificate_data/merit-certificates/{str(count)+" "+data[0]}.jpg')
        else:
